...
interface IMdnsOffloadManager {
  int addProtocolResponses(String networkInterface, in device.google.atv.mdns_offload.IMdnsOffloadManager.OffloadServiceInfo offloadData, IBinder linkToDeath);
